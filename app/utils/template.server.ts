...
export const DEFAULT_TEMPLATES = [
  {
    ...
    buttons: [
      ...
      { id: "update_address", text: "Update Address", type: "QUICK_REPLY" },
  ...
  },
  {
    ...
    headerMediaUrl: "",
    bodyText:
      "Hi {{customer_name}}, your order *#{{order_number}}* from *{{store_name}}* was delivered successfully! 🎉\n\nThank you for shopping with us. Please let us know if you need any assistance with your package.",
    footerText: "{{store_name}}",
  ...
  },
  {
    ...
    buttons: [
      { id: "checkout_cart", text: "Complete My Order", type: "CTA_URL", url: "{{checkout_url}}" },
    ],
    isActive: true,
  },
  {
    ...
    buttonUrl: "{{checkout_url}}",
    buttons: [
      { id: "claim_discount", text: "Claim 10% Off & Checkout", type: "CTA_URL", url: "{{checkout_url}}" },
    ],
    isActive: true,
  },
  {
    ...
    buttonUrl: "{{checkout_url}}",
    buttons: [
      { id: "shop_new", text: "Shop New Arrivals", type: "CTA_URL", url: "{{checkout_url}}" },
    ],
    isActive: false,
  },
  {
